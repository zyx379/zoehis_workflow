...
```powershell
# 方式 1：AI Agent 直接执行
& dev/skills/zoehis-daily-report/scripts/generate-daily-report.ps1

# 方式 2：指定工作区路径
& dev/skills/zoehis-daily-report/scripts/generate-daily-report.ps1 -WorkspaceRoot "D:\zoe_work_space\fj-common"
```
